...
//access the store.state.cart (your array of products the user has saved to the cart)
        ...
        <div class="CartContainer">
            ...
            <div class="Cart-Items">
                ...
                <div class="about">
                    ...
                    <!-- create function like product card for these, for loop that goes to items in cart store -->
